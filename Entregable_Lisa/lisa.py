...
while True :
    ...
    try:
        ...
        if personaje == 'Homer Simpson':
            ...
            with open('C:\\Users\dario\OneDrive\\Documentos\\GitHub\\Entregable-1\\Entregable_Lisa\\{personaje}\{personaje}.csv', 'a') as g: 
                a = csv.DictWriter(g, my_dict1.keys())
                a.writerow(my_dict1)

        elif personaje == 'Lisa Simpson':
            my_dict2 = {"personaje": personaje, "frase": frase}
            with open('C:\\Users\dario\OneDrive\\Documentos\\GitHub\\Entregable-1\\Entregable_Lisa\\{personaje}\{personaje}.csv', 'a') as h: 
                a = csv.DictWriter(h, my_dict2.keys()) 
                a.writerow(my_dict2) 

        else:
            my_dict0 = {"personaje": personaje, "frase": frase}
            with open('C:\\Users\dario\OneDrive\\Documentos\\GitHub\\Entregable-1\\Entregable_Lisa\\general_1.csv', 'a') as f: 
